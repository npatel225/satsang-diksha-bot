...
def choose_challenge(update: Update, context: CallbackContext):
    ...
    keyboard = list(map(lambda tier: [InlineKeyboardButton(tier, callback_data=f'{tier}')], tiers))
